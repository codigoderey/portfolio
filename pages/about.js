          ...
          <div className="content-wrap pb-0">
            <div className="mw-md container mb-5">
              ...
              >
                ...
                <span className="gradient-text gradient-horizon">5 years</span>{' '}
            ...
            <div className="container mw-md mt-5">
              ...
              <div className="row mt-4">
                <div className="col-md-8 offset-1">
                  ...
                  <p className="lead">
                    It all depends on what the customer need. I am always
                    willing to give my customers the best solution possible
                    based in their needs.
                  </p>
                  <p className="lead">
                    I can develop from basic HTML templates and Wordpress sites
                    to full stack applications using technologies like NodeJS,
            ...
            <div className="section text-center mb-0">
              <div className="mw-xs mx-auto ">
                ...
                <div className="mt-4 lead p-3">
                  <p>
                    I personally love to work in the JavaScript environment.
                  </p>
                  <p>
                    When building full stack applications I usually use
                    ExpressJS and combine the API with MongoDB or MySQL
                    databases.
                  </p>
                  <p>
                  ...
                  <p>
                    I also know about emails API like SendGrid and Mailchimp
                    plus much more based on the techonology documentation.
                  </p>
                </div>
